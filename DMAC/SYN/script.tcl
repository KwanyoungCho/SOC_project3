...
analyze -format sverilog $env(LAB_PATH)/RTL/MPDMAC_TOP.sv
analyze -format sverilog $env(LAB_PATH)/RTL/MPDMAC_ENGINE.sv
analyze -format sverilog $env(LAB_PATH)/RTL/MPDMAC_CFG.sv
analyze -format sverilog $env(LAB_PATH)/RTL/MPDMAC_FIFO.sv

set design_name         MPDMAC_TOP
